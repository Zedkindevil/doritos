...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="https://t.me/kindevils"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Than send` `/admincache@kindevilsmanager` `in that chat to refresh admin list in My database.`\n"
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, Kindevil Manager is ready to manage your group.`"
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, Kindevils Manager  is ready to manage your group.`"
            f"\n\n*Admin Tools*"
            f"\n✗ `Basic Admin tools help you to protect and powerup your group.`"
            f"\n✗ `You can ban members, Kick members, Promote someone as admin through commands of bot.`"
            f"\n\n*Welcome*"
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR kindevils manager DEV'S</b>\n"
            
            f"\n`✗ Here Some Developers Helping in Making The Kindevils Manager Bot`",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="arika", url="t.me/realxzed"),
                    InlineKeyboardButton(text="fukato", url="t.me/realxzed"),
                 ],
                 [
                    InlineKeyboardButton(text="zed", url="t.me/realzed"),
                    InlineKeyboardButton(text="kindevils", url="https://t.me/kindevils"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_basichelp"),
